...
const Header = () => {
  ...
  return (
    <header className={`${header ? "bg-white py-6 shadow-lg" : "bg-transparent py-8"} fixed z-50 w-full transition-all duration-500`}>
      <div className="container mx-auto flex flex-col gap-y-6 items-center lg:justify-between lg:flex-row lg:gap-y-0">
        {/* logo */}
        <a href="/">{header ? <img src={LogoDark} className="w-[160px]" alt="" /> : <img src={LogoWhite} className="w-[160px]" alt="" />}</a>
        {/* nav */}
